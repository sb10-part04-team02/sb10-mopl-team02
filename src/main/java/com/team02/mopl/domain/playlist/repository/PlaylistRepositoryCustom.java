...
public interface PlaylistRepositoryCustom {
  ...
  // ownerIdEqual이 있으면 소유자, subscriberIdEqual이 있으면 해당 유저의 활성 구독으로 필터링한다(둘 다 선택)
  ...
  // keyword·소유자·구독자 필터를 적용한 활성 플레이리스트 총 개수
  long countActive(String keyword, UUID ownerIdEqual, UUID subscriberIdEqual);
}
