...
public class IngestionJobListener implements JobExecutionListener {
  ...
  public void afterJob(JobExecution jobExecution) {
    ...
    int inserted = sumContext(steps, ContentIngestionTasklet.CONTEXT_KEY_INSERTED);
    int updated = sumContext(steps, ContentIngestionTasklet.CONTEXT_KEY_UPDATED);
    int skipped = sumContext(steps, ContentIngestionTasklet.CONTEXT_KEY_SKIPPED);
  ...
  private String buildAlertMessage(JobExecution jobExecution, long elapsedMs) {
    ...
    for (StepExecution step : jobExecution.getStepExecutions()) {
      message
          ...
          .append(", inserted=")
          .append(
              step.getExecutionContext().getInt(ContentIngestionTasklet.CONTEXT_KEY_INSERTED, 0))
          .append(", updated=")
          .append(step.getExecutionContext().getInt(ContentIngestionTasklet.CONTEXT_KEY_UPDATED, 0))
          .append(", skipped=")
          .append(step.getExecutionContext().getInt(ContentIngestionTasklet.CONTEXT_KEY_SKIPPED, 0))
          .append(", failed=")
