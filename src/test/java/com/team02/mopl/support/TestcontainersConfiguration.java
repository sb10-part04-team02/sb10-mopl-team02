 ...
 *
 * <p>주의: {@code 01_schema_v7.sql}은 {@code src/main/resources}의 사본이다. 스키마 변경 시 양쪽을 동기화해야 한다.
 */
...
public class TestcontainersConfiguration {
  ...
  PostgreSQLContainer<?> postgresContainer() {
    return new PostgreSQLContainer<>("postgres:16").withInitScript("01_schema_v7.sql");
  }
}
